...
public class App {
    public static void main(String[] args) {
        ...
        Habitacion habitacion1 = new Habitacion(101, 250000, TipoHabitacion.DOBLE, );
        Habitacion habitacion2 = new Habitacion(102, 300000, TipoHabitacion.SUITS, List<Servicio>servicios);
